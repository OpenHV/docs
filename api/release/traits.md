This documentation is aimed at modders. It displays all traits with default values and developer commentary. Please do not edit it directly, but add new `[Desc("String")]` tags to the source code. This file has been automatically generated for version 20210919 of OpenHV.
...
| Condition | *(required)* | String | The condition to apply. Must be included in the target actor's ExternalConditions list. |
| Duration | 0 | Integer | Duration of the condition (in ticks). Set to 0 for a permanent condition. |
| Dimensions | *(required)* | 2D Cell Vector | Size of the footprint of the affected area. |
...
| Crushes |  | Collection of CrushClass | e.g. crate, wall, infantry |
| CrushDamageTypes |  | Collection of DamageType | Types of damage that are caused while crushing. Leave empty for no damage types. |
| TerrainSpeeds | *(required)* | Dictionary with Key: String, Value TerrainInfo | Lower the value on rough terrain. Leave out entries for impassable terrain. |
...
| Property | Default Value | Type | Description |
| -------- | --------------| ---- | ----------- |
| Type | *(required)* | String | Type of TeleportNetwork that pairs up, in order for it to work. |
...
Requires trait: [`MissileSpawnerParent`](#missilespawnerparent).
...
| -------- | --------------| ---- | ----------- |
| Type | *(required)* | String | Type of TeleportNetwork that pairs up, in order for it to work. |
| ValidStances | Ally | PlayerRelationship | Stances requirement that targeted TeleportNetwork has to meet in order to teleport units. |
| Delay | 20 | Integer | Time in ticks to wait for the teleporter to charge up. |
...
Requires traits: [`BallisticMissile`](#ballisticmissile), [`BodyOrientation`](#bodyorientation), [`RenderSprites`](#rendersprites).
...
| Property | Default Value | Type | Description |
| -------- | --------------| ---- | ----------- |
| ExitCell | *(required)* | 2D Cell Vector | Exit offset associated with the animation. |
| Sequence | *(required)* | String | Sequence name to use. |
| Palette |  | String | Custom palette name. |
| IsPlayerPalette | False | Boolean | Custom palette is a player palette BaseName. |
| RequiresCondition |  | BooleanExpression | Boolean expression defining the condition to enable this trait. |
